...
Recreate the idea from [Exercise 104](../../chapter-01/exercise-104/README.md), but swap the hosted model for a **local Ollama model** running on your own machine.
...
1. Start from the code in [Exercise 104](../../chapter-01/exercise-104/README.md).
...
← Back to [Exercise Index](../../README.md) | Related: [Exercise 104](../../chapter-01/exercise-104/README.md) | Previous: [Exercise 304](../exercise-304/README.md)
