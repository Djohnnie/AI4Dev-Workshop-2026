...
public class CopilotChatHistory
{
    ...
    public List<string> ContributingAgents { get; private set; } = new List<string>();
    ...
    public void AddSystemMessage(string message) =>
        Messages.Add(new CopilotChat { Role = CopilotChatRole.System, Content = message });

    public void AddUserMessage(string message) =>
        Messages.Add(new CopilotChat { Role = CopilotChatRole.User, Content = message });

    public void AddAssistantMessage(string message) =>
        Messages.Add(new CopilotChat { Role = CopilotChatRole.Assistant, Content = message });

    public void AddDebug(bool isQuestion, string message, string agentName) =>
        Debug.Add(new DebugChat { IsQuestion = isQuestion, AgentName = agentName, Content = message });
