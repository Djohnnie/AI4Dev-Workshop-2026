...
[🏠 Workshop Home](../../../README.md) | [🏋️ Exercise Index](../../README.md) | [📘 Chapter 4 Overview](../../../content/2-day/chapter-4/README.md) | [📊 Chapter 4 Slides](../../../content/2-day/chapter-4/SLIDES.md)
...
1. Open a terminal in `exercises/chapter-4/exercise-401/TaskManager`.
2. Restore and run:
...
5. Open VS Code in `exercises/chapter-4/exercise-401/TaskManager` and enable **Agent Mode** in the Copilot chat panel (the toggle in the chat input area).
...
← Back to [Exercise Index](../../README.md) | Related: [Slide deck](../../../content/2-day/chapter-4/SLIDES.md)
