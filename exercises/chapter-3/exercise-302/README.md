...
9. Run the program:
   ...
   ```bash
   cd exercises/chapter-3/exercise-302
   dotnet run
   ```
...
← Back to [Exercise Index](../../README.md) | Related: [Slide deck](../../../content/2-day/chapter-3/SLIDES.md) | Previous: [Exercise 301](../exercise-301/README.md) | Next: [Exercise 303](../exercise-303/README.md)
