...
The tool itself performs code obfuscation — the same technique you reversed-engineered in [Exercise 203](../../chapter-2/exercise-203/README.md). Understanding how obfuscation works (from the inside this time) and then wrapping it in a standard protocol that any AI assistant can call is the perfect synthesis of the week's themes: AI foundations, responsible use, prompting, the full SDLC, and agentic tool-building.
...
4. Examine the output — compare it with [Exercise 203's](../../chapter-2/exercise-203/README.md) `C0.cs`.
