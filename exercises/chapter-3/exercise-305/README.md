...
> **Chapter:** Chapter 3, Exercise 5  
> **Skill focus:** Local models, tool calling, comparing hosted vs local inference  
> **Difficulty:** ⭐⭐

[🏠 Workshop Home](../../../README.md) | [🏋️ Exercise Index](../../README.md) | [📘 Chapter 3 Overview](../../../content/2-day/chapter-3/README.md) | [📊 Chapter 3 Slides](../../../content/2-day/chapter-3/SLIDES.md)

---

## Goal

Recreate the idea from [Exercise 104](../../chapter-1/exercise-104/README.md), but swap the hosted model for a **local Ollama model** running on your own machine.
...
1. Start from the code in [Exercise 104](../../chapter-1/exercise-104/README.md).
...
3. Run the app:
   ...
   ```bash
   cd exercises/chapter-3/exercise-305
   dotnet run
   ```
...
← Back to [Exercise Index](../../README.md) | Related: [Exercise 104](../../chapter-1/exercise-104/README.md) | Previous: [Exercise 304](../exercise-304/README.md)
