...
1. Open a terminal in `exercises/chapter-04/exercise-401/TaskManager`.
2. Restore and run:
...
5. Open VS Code in `exercises/chapter-04/exercise-401/TaskManager` and enable **Agent Mode** in the Copilot chat panel (the toggle in the chat input area).
