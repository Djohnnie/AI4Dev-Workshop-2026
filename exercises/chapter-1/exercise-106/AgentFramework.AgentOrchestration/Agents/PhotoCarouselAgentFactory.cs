...
{
    private readonly string _description = "An agent that has real-time knowledge on my displayed photos via PhotoCarousel (get information about current, previous and next displayed photo)";
