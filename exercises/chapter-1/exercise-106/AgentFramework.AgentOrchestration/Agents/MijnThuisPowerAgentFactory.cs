...
{
    private readonly string _description = "An agent that has real-time knowledge on my power usage via MijnThuis (power usage; peak power usage this month; energy imported and exported today and this month; energy cost today and this month; current energy consumption and injection price)";
