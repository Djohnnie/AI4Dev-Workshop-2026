...
2. **Build and run the application:**
   ```bash
   cd exercises/chapter-1/exercise-102
   dotnet build
   dotnet run
   ```
...
← Back to [Exercise Index](../../README.md) | Previous: [Exercise 101](../exercise-101/README.md) | Next: [Exercise 103](../exercise-103/README.md)
