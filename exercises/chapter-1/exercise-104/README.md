...
2. Run the app:
   ...
   ```bash
   cd exercises/chapter-1/exercise-104
   dotnet run
   ```
...
← Back to [Exercise Index](../../README.md) | Previous: [Exercise 103](../exercise-103/README.md) | Next: [Exercise 105](../exercise-105/README.md)
