...
{
    private readonly string _description = "An agent that has real-time knowledge on my smart lock via MijnThuis (current lock state; current door state; smart lock battery charge percentage)";
