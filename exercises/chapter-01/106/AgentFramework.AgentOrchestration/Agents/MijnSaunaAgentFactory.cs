...
{
    private readonly string _description = "An agent that has real-time knowledge on my sauna via MijnSauna (sauna status: off, sauna or infrared; current temperature inside sauna cabin)";
