...
{
    private readonly string _description = "An agent that has real-time knowledge on my electric car via MijnThuis (current car location; car battery charge percentage and health; locking and unlocking car; starting and stopping car charging)";
