...
- [Exercise 101 — Token Visualizer](../../../exercises/chapter-1/exercise-101/README.md) — see how prompts and code are split into tokens with an Azure OpenAI-backed terminal app
- [Exercise 102 — Stateless LLM Chat](../../../exercises/chapter-1/exercise-102/README.md) — build a first console chat app and discover why an LLM is stateless by default
- [Exercise 105 — MCP Tool Calls](../../../exercises/chapter-1/exercise-105/README.md) — move date/time tools behind an MCP server and connect a chat client to it
- [Exercise 301 — Who Does Copilot Picture?](../../../exercises/chapter-3/exercise-301/README.md) — surface and correct bias in AI-generated sample data

> Optional deeper dives if time allows: [Exercise 103 — Chat History & Roles](../../../exercises/chapter-1/exercise-103/README.md), [Exercise 104 — Tool Calls](../../../exercises/chapter-1/exercise-104/README.md), and [Exercise 106 — Agent Orchestration](../../../exercises/chapter-1/exercise-106/README.md).
