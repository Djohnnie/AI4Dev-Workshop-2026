[🏠 Workshop Home](../../../README.md) | [📊 Slides](SLIDES.md) | [← Chapter 2 — Meet Your New Best Friend & Let It Take the Wheel](../chapter-2/README.md) | [Chapter 4 — Get Your Hands Dirty: Real-World AI in Action →](../chapter-4/README.md)
...
- [Exercise 501 — Context Window Copilot Clone](../../../exercises/chapter-5/exercise-501/README.md) — simulate how Copilot builds and prioritises context, then assemble a fill-in-the-middle prompt within a token budget
- [Exercise 502 — Prompt Arena](../../../exercises/chapter-5/exercise-502/README.md) — compare one-shot, few-shot, iterative, and deliberately bad prompts against the same coding target
- [Exercise 503 — Context Variables Playground](../../../exercises/chapter-5/exercise-503/README.md) — try @workspace, #file, #symbol, and #changes on a real codebase to see how scope changes the answer
- [Exercise 504 — Prompt Pattern Playground](../../../exercises/chapter-5/exercise-504/README.md) — apply comment-driven, test-first, persona-based, and stepwise diff-driven prompting to the same task
...
[🏠 Workshop Home](../../../README.md) | [← Chapter 2 — Meet Your New Best Friend & Let It Take the Wheel](../chapter-2/README.md) | [Chapter 4 — Get Your Hands Dirty: Real-World AI in Action →](../chapter-4/README.md)
