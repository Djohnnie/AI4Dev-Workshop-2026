[🏠 Workshop Home](../../../README.md) | [📝 Chapter Overview](README.md) | [Chapter 1 →](../chapter-1/README.md)
...
![Slide 02 — Who is your trainer?](slide-002.svg)
...
This slide explains a balanced position on AI tooling. The trainer is honest about still having doubts, but also recognizes the real productivity gains these tools can offer when used well.
...
![Slide 06 — Before We Start — Set Up Your Laptop](slide-006.svg)

> **TL;DR:** Before the workshop begins, make sure .NET and Visual Studio Code are installed and working on your machine.

This slide is about removing friction early. If everyone has the required tools ready, the group can spend time learning instead of troubleshooting basic setup problems during the exercises.

The two key tools are the .NET 10 SDK and Visual Studio Code. The SDK gives you the compiler and CLI needed to build and run the exercises, while VS Code gives you a lightweight editor with strong extension support and built-in AI development features. The version checks shown on the slide are a quick way to confirm your environment is ready.

## Slide 07 — Who are you?

![Slide 07 — Who are you?](slide-007.svg)
...
![Slide 08 — Day 1 - What is on the agenda?](slide-008.svg)

> **TL;DR:** Day 1 builds the foundation: understanding AI, learning Copilot, using it responsibly, and exploring agent-style workflows.

This slide gives participants a map of the first day. It starts with the basics of AI and large language models, then moves into practical GitHub Copilot usage, responsible adoption, and finally more advanced ways of working with AI in developer tools.

That progression is deliberate. Before you can use AI well, you need both conceptual understanding and practical habits. Day 1 is designed to build that base before the workshop moves into deeper prompt, workflow, and end-to-end delivery topics.

## Slide 09 — Day 2 - What is on the agenda?

![Slide 09 — Day 2 - What is on the agenda?](slide-009.svg)

> **TL;DR:** Day 2 focuses on prompting, software lifecycle use cases, team practices, and a realistic end-to-end AI-assisted build.

This slide previews the second day of the workshop. The topics become more practical and more integrated, moving from prompt quality into testing, documentation, refactoring, review, and full workflow execution.

By the end of Day 2, the goal is not just to know what AI can do, but to understand how to fit it into real development work. That includes knowing when to lean on it, how to steer it well, and how to keep quality high as a team.
