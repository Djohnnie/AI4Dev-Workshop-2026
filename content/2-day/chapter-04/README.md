...
The biggest chapter of the workshop: six ways to put Copilot to work across the IDE, the terminal, and GitHub — one section at a time. Participants move from occasional user to confident daily driver, with one principle running through every surface: Copilot gets the head start, you stay in control, and you own everything you commit.
...
- Capture team knowledge as reusable **prompt files** and agent-loaded **skill files**
...
### 1. Agent Mode — Agentic Coding *(Section 1 of 6)*

- **From occasional user to daily driver** — the chapter previews the six surfaces: Agent Mode, Plan Mode, Copilot CLI, Copilot on GitHub.com, Custom Instructions, and Prompt & Skill Files. Six surfaces, one workflow — you stay in control of every one.
...
### 3. Plan Mode — Design Before You Build *(Section 2 of 6)*
...
### 4. GitHub Copilot CLI — AI in the Terminal *(Section 3 of 6)*
...
### 5. Copilot on GitHub.com — In the Browser *(Section 4 of 6)*
...
### 6. Custom Instructions — Teach Copilot Your Standards *(Section 5 of 6)*
...
### 7. Prompt Files & Skill Files — Capture Team Knowledge *(Section 6 of 6)*
...
### 8. Wrap-Up, Quizzes & Labs

- **Your daily-driver toolkit:** six tools, one principle — reach for the right scope and review everything you keep. Agent Mode (goal in, work done, you approve at every checkpoint); Copilot Edits & CLI (coordinated multi-file edits in the IDE, suggest & explain in the terminal); on GitHub.com (PR descriptions, code review, issue triage, natural-language search); Instructions & Files (custom instructions set the defaults, prompt & skill files capture expertise). The thread through all six: Copilot gets the head start, you stay in control, and you own everything you commit.
...
## 🗒️ Facilitator Notes
- This is the largest chapter (46 slides, six sections) — keep momentum by treating each section as a self-contained beat, and use the per-section exercises as natural pauses.
