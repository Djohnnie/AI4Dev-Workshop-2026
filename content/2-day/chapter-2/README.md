[🏠 Workshop Home](../../../README.md) | [📊 Slides](SLIDES.md) | [← Chapter 1 — Welcome to the AI Revolution!](../chapter-1/README.md) | [Chapter 3 — Power with Purpose: Using AI Responsibly →](../chapter-3/README.md)
...
- [Exercise 201 — Factorial Calculator](../../../exercises/chapter-2/exercise-201/README.md) — practise ghost-text completions by implementing iterative and recursive factorial methods; accept with `Tab`, `Alt+[` / `Alt+]`, or word by word, then compare solutions
- [Exercise 202 — Palindrome Checker](../../../exercises/chapter-2/exercise-202/README.md) — steer ghost text with short line-by-line intent comments, then review casing, punctuation, and edge cases critically
- [Exercise 203 — Mystery Processor](../../../exercises/chapter-2/exercise-203/README.md) — use Copilot Chat and `/explain` to understand obfuscated code and form a hypothesis *before* looking at the tests
- [Exercise 204 — Shortest Path](../../../exercises/chapter-2/exercise-204/README.md) — fix a subtle Dijkstra bug by combining the failing test, algorithm context, and `/fix`, applying the smallest correct change
- [Exercise 205 — Caesar Cipher](../../../exercises/chapter-2/exercise-205/README.md) — use `/tests` to generate a starter xUnit suite, then add the missing edge cases (wrap-around, negative shifts, non-letters, round trips)
- [Exercise 206 — String Search](../../../exercises/chapter-2/exercise-206/README.md) — use `/doc` to document an existing KMP implementation so the next reader can understand the algorithm quickly
- [Lab 201 — Ultimate Snake](../../../labs/chapter-2/lab-201/README.md) — build a complete Snake game using ghost text, Ask mode, and inline chat only
...
[🏠 Workshop Home](../../../README.md) | [← Chapter 1 — Welcome to the AI Revolution!](../chapter-1/README.md) | [Chapter 3 — Power with Purpose: Using AI Responsibly →](../chapter-3/README.md)